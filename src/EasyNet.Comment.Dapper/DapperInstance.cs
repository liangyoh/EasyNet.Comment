...
namespace EasyNet.Comment.Dapper
{
    ...
    public class DapperInstance:IDapper
    {
        ...
        /// <returns></returns>
        public long Insert(IDbConnection connection, dynamic data, string table, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        /// <param name="commandTimeout"></param>
        /// <returns></returns>
        public Task<long> InsertAsync(IDbConnection connection, dynamic data, string table, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var obj = data as object;
            var properties = GetProperties(obj);
            var columns = string.Join(",", properties);
        ...
        /// <param name="commandTimeout"></param>
        /// <returns></returns>
        public int Update(IDbConnection connection, dynamic data, dynamic condition, string table, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var obj = data as object;
        ...
        /// <param name="commandTimeout"></param>
        /// <returns></returns>
        public Task<int> UpdateAsync(IDbConnection connection, dynamic data, dynamic condition, string table, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var obj = data as object;
            var conditionObj = condition as object;
        ...
        /// <param name="commandTimeout"></param>
        /// <returns></returns>
        public int Delete(IDbConnection connection, dynamic condition, string table, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var conditionObj = condition as object;
            var whereFields = string.Empty;
        ...
        /// <param name="commandTimeout"></param>
        /// <returns></returns>
        public Task<int> DeleteAsync(IDbConnection connection, dynamic condition, string table, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var conditionObj = condition as object;
            var whereFields = string.Empty;
            var whereProperties = GetProperties(conditionObj);
        ...
        /// <param name="commandTimeout"></param>
        /// <returns></returns>
        public int GetCount(IDbConnection connection, object condition, string table, bool isOr = false, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        /// <param name="commandTimeout"></param>
        /// <returns></returns>
        public Task<int> GetCountAsync(IDbConnection connection, object condition, string table, bool isOr = false, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        /// <param name="commandTimeout"></param>
        /// <returns></returns>
        public IEnumerable<dynamic> QueryList(IDbConnection connection, dynamic condition, string table, string columns = "*", bool isOr = false, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        /// <param name="commandTimeout"></param>
        /// <returns></returns>
        public Task<IEnumerable<dynamic>> QueryListAsync(IDbConnection connection, dynamic condition, string table, string columns = "*", bool isOr = false, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        /// <param name="commandTimeout"></param>
        /// <returns></returns>
        public IEnumerable<T> QueryList<T>(IDbConnection connection, object condition, string table, string columns = "*", bool isOr = false, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        /// <param name="commandTimeout"></param>
        /// <returns></returns>
        public Task<IEnumerable<T>> QueryListAsync<T>(IDbConnection connection, object condition, string table, string columns = "*", bool isOr = false, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        /// <param name="commandTimeout"></param>
        /// <returns></returns>
        public IEnumerable<T> QuereyProcedure<T>(IDbConnection connection, DynamicParameters condition, string procedure, IDbTransaction transaction = null, int? commandTimeout = null)
        {
